    ...
    return (
        ...
        <footer className="bg-white dark:bg-gray-900">
            <div className="container p-6 mx-auto">
                        ...
                        <div className="px-6 text-center lg:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row mt-4 mx-5">
                                <div className="flex items-center justify-center space-x-2 mb-2 sm:mb-0">
                                    ...
                                    <a href="https://www.facebook.com/profile.php?id=61555179124157">
                                        <button className="bg-blue-600 px-4 sm:px-4 sm:py-2 py-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
                                            <svg
                                    ...
                                    <a href="https://twitter.com/mydr24">
                                        <button className="bg-blue-400 px-4 sm:px-4 sm:py-2 py-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="h-5 w-5"
                                                fill="currentColor"
                                    ...
                                    <a href="https://www.instagram.com/mydrtwenty4/">
                                        <button className=" px-4 sm:px-4 sm:py-2 py-2 font-semibold text-white inline-flex items-center space-x-2 rounded" style={{ backgroundColor: '#c13584' }}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="h-5 w-5"
                                                fill="currentColor"
                                    ...
                                    <a href="">
                                        <button className="bg-red-600 px-4 sm:px-4 sm:py-2 py-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="h-5 w-5"
                                                fill="currentColor"
                    ...
                    <div className="mt-6 lg:mt-0 lg:flex-1">
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                            ...
                            <div className="text-center sm:text-left">
                                ...
                                <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Doctor consultation</a>
                                <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Pharmacy</a>
                                <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Diagnostic tests</a>
                                <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Ambulance Service</a>
                                <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Healthcare</a>
                            </div>
                ...
                <div>
                    <p className="text-center text-gray-500 dark:text-gray-400">© Accufly 2023 - All rights reserved</p>
                </div>
            </div>
        </footer>
