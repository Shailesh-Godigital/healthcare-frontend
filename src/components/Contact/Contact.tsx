...
function Contact() {
    return (
        <div>
            <section className="bg-gray-100 dark:bg-[#101929] rounded-md p-2">
                        ...
                        <div className="lg:w-1/2 lg:order-1">
                            ...
                            <div className="mt-6 space-y-8 md:mt-8">
                                ...
                                <p className="flex items-start -mx-2">
                                    ...
                                    <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">+91 93117 91119</span>
                                </p>
                                ...
                                <p className="flex items-start -mx-2">
                                    ...
                                    <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">customer.care@accufly.com</span>
                                </p>
                            </div>
