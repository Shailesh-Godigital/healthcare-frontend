                ...
                {isMobile ? (
                            ...
                            <li>
                                <div className="relative dark:bg-[#101929] flex flex-col min-w-0 break-words bg-white w-half mb-6 rounded-lg">
                                    <div className="px-6">
                                        ...
                                        <div className="lg:hidden block mt-4 relative z-10">
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="/labVendorRegistration" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    ...
                                    <span className="flex-1 ms-3 whitespace-nowrap">lab Vendor Registration</span>
                                    {/* <span className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">Pro</span> */}
                                </a>
                            </li>
                            <li>
                                <a href="/package" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <li>
                                <a href="/userManagement" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
